    	...
    	<div class="col-md-4">
      		<div class="box">
        		<div class="box-content">
					<p style="color:black"><b>Umur</b> : 0 - 6 bulan</p>
          			<p style="color:black">Anak Anda tergolong Kategori : <b>Seimbang</b></p>
          			<br>
          				<div class="row mb30">
           					<div class="col-sm-12">
    ...
    <div class="row">
		...
		<tbody>
			...
			<tr>
				<td>Susu/Makanan</td>
				<td>ASI/SUSU</td>
				<td>ASI/SUSU,Pisang,Sari Jeruk,Pepaya</td>
				<td>Bubur Susu, Bubur Saring</td>
				<td>Biskuit Bayi,Buah</td>
				<td>Bubur Susu</td>
				<td>ASI/SUSU</td>
				<td>ASI/SUSU</td>
			</tr>
