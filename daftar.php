				  ...
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo grid">
						<div class="grid__item color-3">
							<h1><a class="link link--nukun" href="indexdokter.php"><img class="logo" src="logowarna.png"></a></h1>
						</div>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item"><a href="indexdokter.php" class="menu__link">Home</a></li> 
							<li class="menu__item menu__item--current"><a href="daftar.php" class="menu__link">Jadwal Konsultasi</a></li>
...
<div class="container">
		<div class="table-responsive">
			<div class="page-header">
				<h3>Jadwal Permintaan Konsultasi</h3>
			</div>
			<table class="table">
				<thead>
					<tr>
